...
export default function SignIn() {
    ...
    const authMsg = ((username === "metaharvest") && (password === "win2023")) ? "Hi " + username + "! You have logged in successfully. You can now access the protected page." : "You are not logged in. Please log in to continue.";
