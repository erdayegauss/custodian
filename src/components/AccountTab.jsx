...
import {assetsData, partnerData, Vault} from '../data/dummy';
...
const AccountTab = (props) => {
    ...
    const handleTx = () => {
        ...
        axios.post('http://localhost:8089/api/vaults', {
            name: name,
        }, {
            headers: {
                ...
                <TableRow sx={{'& > *': {borderBottom: 'unset'}}}>
                    ...
                    <TableCell>
                        ...
                        <div class="acc1">
                            ...
                            <InfoAccount dataSource={assetsData} dataSource1={row.Accounts} vaultName={row.name}
                                         display={row.image} image={row.image}></InfoAccount>
                        </div>
                    ...
                    <TableCell style={{paddingBottom: 0, paddingTop: 0}} colSpan={6}>
                        <Collapse in={open} timeout="auto" unmountOnExit>
                            <Box sx={{margin: 1}}>
                                ...
                                <div>
                                    <AddWalletPopup vaultId={row.vaultId} vaultName={row.name}
                                                    refreshRows={refreshRows}></AddWalletPopup>
                                </div>
